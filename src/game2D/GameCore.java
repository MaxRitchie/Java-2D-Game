...
public abstract class GameCore extends JFrame implements KeyListener, MouseListener {
	 ...
	 * 
	 * This method will call your update() method followed by your draw() method to
	 * display the updated game state. It implements double buffering for both full
	...
	/**
	 * Handles the keyReleased event to check for the 'Escape' key being pressed. If
	 * you override this method, make sure you allow the user to stop the game.
	 */
	 ...
	 * that has passed. You should override this in your game class to do something
	 * useful.
	 */
	...
	/**
	 * Subclasses must override this method to draw output to the screen via the
	 * Graphics2D object 'g'.
	 * 
